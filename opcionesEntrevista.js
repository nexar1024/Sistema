...
function mostrarOpciones(id_pregunta) {
    ...
    $.post("ajax_opcionEntrevista/mostrarOpciones.php", {
...
function agregarOpcion() {
    ...
    $.post("ajax_opcionEntrevista/agregarOpcion.php",
        {
            id_pregunta         : id_pregunta,
            valor              : valor
        },
...
function eliminarOpcion(id_opcion) {
    ...
    if (conf == true) {
        ...
        $.post("ajax_opcionEntrevista/eliminarOpcion.php", {id_opcion: id_opcion}, function (data, status) {
...
function obtenerDetallesOpcion(id_opcion) {
    ...
    $.post("ajax_opcionEntrevista/mostrarDetallesOpcion.php", {id_opcion: id_opcion}, function (data, status) {
        // PARSE json data
...
function modificarDetallesOpcion() {
    ...
    $.post("ajax_opcionEntrevista/modificarDetallesOpcion.php",
        {
            id_opcion : id_opcion,
            valor      : valor
        },
