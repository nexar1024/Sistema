...
<html class="no-js" lang="">
    ...
    <div class="container">
      ...
      <!-- Example row of columns -->
        <h2>Ubicación de entrevistas realizadas</h2>
        <p>Puntos exactos donde fueron hechas las entrevistas</p>
        <input type="search" placeholder="Buscar nombre" class="map" center>
        <div id="mapaEntrevista" class="z-depth-1-half map-container" style="height: 450px; width:100%;">
    </div>     
    ...
    <script src="//ajax.googleapis.com/ajax/libs/jquery/1.11.2/jquery.min.js"></script>
        ...
        <script>
          ...
          function initMap() {
              var map = new google.maps.Map(document.getElementById('mapaEntrevista'), {
              ...
              downloadUrl('https://sistemadegeolocalizacion.herokuapp.com/xmlentrevista.php', function(data) {
                  ...
                  Array.prototype.forEach.call(markers, function(markerElem) {
                      ...
                      var descripcion = markerElem.getAttribute('id_entrevista');
                      ...
                      const contentString =
                          ...
                          '<div id="bodyContent">' +
                          '<br>'+
                          "<p><b>" + "Id de entrevista realizada: "+descripcion + "</p>" +
                          "</p>" +
                          "</div>" +
                          "</div>";
